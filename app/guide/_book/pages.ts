...
export const PAGES: BookPage[] = [
  ...
  },
  {
    ...
    title: "등록 완료!",
    body:
      "다시 로그인하면 이제 수심달 RED의 모든 기능을 자유롭게 쓸 수 있어요.\n여러분의 학습 여정이 본격적으로 시작돼요.",
  ...
  // ─────────── Ch 5 ───────────
  {
    ...
    matty: M.hipster,
    eyebrow: "Chapter 5",
    title: "본격 학습 — 차근차근 18단계",
    body:
      "수심달 RED는 한 단원을 여러 단계로 쪼개서 꼼꼼하게 공부해요.\n압도되지 말고, 한 단계씩 따라오면 어느새 심화까지 도달해요.",
  },
  {
    id: "5-2",
    chapter: 5,
    ...
    body:
      "학습 시작 전, AI 매티가 준 미션과 내가 직접 설정한 미션으로 오늘의 목표를 정해요.\n목표가 명확하면 집중력이 달라져요. 난이도가 높을수록 보상도 커요.",
  ...
  },
  {
    ...
    eyebrow: "1군 · 워밍업",
    title: "가볍게 시작하는 워밍업",
    body: "오늘 배울 내용을 살짝 훑어보면서 머리를 깨우는 단계예요.",
    stages: [
      {
        name: "학습 스트레칭",
        tip: "오늘 배울 내용을 가볍게 훑어요.",
  ...
  },
  {
    ...
    eyebrow: "2군 · 기본",
    title: "개념을 차곡차곡 다지기",
    body: "빈칸 채우기부터 객관식까지, 개념을 머릿속에 단단히 새기는 4단계예요.",
    stages: [
      {
        name: "개념 정리하기",
        tip: "빈칸 채우기로 개념을 떠올려요.",
        shots: ["/images/ios/개념_정리하기_01.png", "/images/ios/개념_정리하기_02.png"],
      },
      {
        name: "개념 연습하기",
        tip: "직접 계산하며 손에 익혀요. 스스로 정직하게 채점.",
        shots: ["/images/ios/개념_연습하기_01.png", "/images/ios/개념_연습하기_02.png"],
      },
      {
        name: "개념 다지기",
      ...
      },
      {
        ...
        shots: ["/images/ios/개념_테스트_01.png", "/images/ios/개념_테스트_02.png"],
      },
    ],
  },
  {
    ...
    eyebrow: "3군 · 응용",
    title: "실전 감각을 키우는 응용",
    body: "배운 개념을 어떻게 ‘쓰는지’ 익히는 시간. 약점만 콕 집어 훈련해요.",
    stages: [
      {
        name: "개념 활용하기",
        tip: "실제 문제에 개념을 적용해봐요.",
        shots: ["/images/ios/개념_활용하기_01.png", "/images/ios/개념_활용하기_02.png"],
      },
      {
        name: "개념 점검하기",
        tip: "내가 어떤 개념을 썼는지 직접 선택해요.",
        shots: ["/images/ios/개념_점검하기_01.png", "/images/ios/개념_점검하기_02.png"],
      },
      {
        name: "개념별 훈련하기",
        tip: "약한 개념만 골라 집중 훈련.",
        shots: ["/images/ios/개념별_훈련하기_01.png", "/images/ios/개념별_훈련하기_02.png"],
      },
      {
        name: "문제 해석하기",
        tip: "문제를 구조화해보는 훈련. 어떤 개념이 필요한지 분석해요.",
        shots: ["/images/ios/문제_해석하기_01.png", "/images/ios/문제_해석하기_02.png"],
      },
    ],
  },
  {
    ...
    eyebrow: "4군 · 정리",
    title: "단원을 마무리하는 정리",
    body: "한 단원이 끝날 때, 배운 모든 걸 시험처럼 정리해보는 단계들이에요.",
    stages: [
      {
        name: "개념 마무리",
        tip: "이번 중단원의 개념을 깔끔하게 정리.",
        shots: ["/images/ios/개념_마무리_01.png"],
      },
      {
        name: "중단원 마무리 1step / 2step",
        tip: "기본 점검 → 더 어려운 문제로 실력 시험.",
        shots: ["/images/ios/중단원_마무리_1step_01.png", "/images/ios/중단원_마무리_2step_01.png"],
      },
      {
        name: "테스트 워밍업 · 중단원 / 대단원 테스트",
        tip: "시험 모드로 들어가기 전 컨디션 점검 → 실전 풀이.",
        shots: [
          "/images/ios/테스트_워밍업_01.png",
          "/images/ios/중단원_테스트_1_2회_01.png",
          "/images/ios/대단원_테스트_1_2회_01.png",
        ],
      },
    ],
  },
  {
    ...
    matty: M.honor,
    eyebrow: "5군 · 심화",
    title: "최고 난이도로 한 걸음 더",
    body: "기본을 단단히 했다면 이제 진짜 실력자의 길로 가볼까요.",
    stages: [
      {
        name: "심화 1step",
        tip: "기본 개념이지만 난이도가 높은 문제. 머리를 좀 써야 해요.",
        shots: ["/images/ios/심화_1step_01.png", "/images/ios/심화_1step_02.png"],
      },
      {
        name: "심화 2step",
        tip: "확장 개념·특별한 풀이법이 필요한 문제.",
        shots: ["/images/ios/심화_2step_01.png", "/images/ios/심화_2step_02.png"],
      },
      {
        name: "심화 3step",
        tip: "지금까지 배운 모든 개념 총동원! 최강 난이도.",
        shots: ["/images/ios/심화_3step_01.png", "/images/ios/심화_3step_02.png"],
      },
    ],
  },
  ...
  // ─────────── Ch 8 ───────────
  {
    ...
    title: "다시 풀어볼 시간 — 챌린지",
    body:
      "내가 풀어본 문제를 다시 풀어보는 RED의 강력한 도구예요.\n‘답을 찾는’ 연습보다 **‘식을 쓰는’ 연습**이 챌린지의 핵심이에요.",
  },
  {
    id: "8-2",
    chapter: 8,
  ...
  // ─────────── Ending ───────────
  {
    ...
    eyebrow: "Final Page",
    title: "이제 RED와 함께할 준비가 모두 끝났어요",
    body:
      "수심달 RED는 도구일 뿐이에요. 하지만 그 과정 속에 남는 **여러분의 습관은 ‘진짜’**가 될 거예요.\n여러분 안에 숨어 있는 무한한 가능성을 저와 함께 발견해봐요.\n언제나 곁에서 응원할게요.\n\n— 모범생 매티 드림",
  },
];
